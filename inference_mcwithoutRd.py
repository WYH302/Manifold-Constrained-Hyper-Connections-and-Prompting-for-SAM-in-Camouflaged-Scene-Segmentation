...
def eval_psnr(loader, model, vlm_model, processor, mamba_model, tokenizer,
    ...
    model.eval()
    print(f"\n=== Start Evaluation (Integrated Model - Without RankDice-RMA) ===")
    ...
    with torch.no_grad():
        for step, (image, gt2D, img_1024_ori, img_path) in enumerate(loader):
            ...
            if not model.use_rankdice:
                threshold = hyper_cond.get('threshold', 0.5)  
...
def main():
    ...
    parser.add_argument("-test_data_path", type=str,
                        default="/root/autodl-tmp/data/COD10K_Inference",
                        help="Test data path")
    parser.add_argument("-results_dir", type=str,
                        default="/root/autodl-tmp/MC-SAM/result/COD10K",
    ...
    integrated_model.use_rankdice = False  
